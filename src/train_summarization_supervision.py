...
parser.add_argument('--test_output_file_name',type=str, default='samsum_supervision_trial2.txt')
...
if args.dataset_name=='samsum':
    total_dataset = SamsumDataset_total(args.encoder_max_len,args.decoder_max_len,tokenizer,extra_supervision=True,paracomet=args.use_paracomet)
    train_dataset = total_dataset.getTrainData()
    eval_dataset = total_dataset.getEvalData()
    test_dataset = total_dataset.getTestData()
elif args.dataset_name=='dialogsum':
    total_dataset = DialogsumDataset_total(args.encoder_max_len,args.decoder_max_len,tokenizer,extra_supervision=True,paracomet=args.use_paracomet)
    train_dataset = total_dataset.getTrainData()
    eval_dataset = total_dataset.getEvalData()
    test_dataset = total_dataset.getTestData()
elif args.dataset_name=='mediasum':
    total_dataset = MediasumDataset_total(args.encoder_max_len,args.decoder_max_len,tokenizer,extra_supervision=True,paracomet=args.use_paracomet)
    train_dataset = total_dataset.getTrainData()
    eval_dataset = total_dataset.getEvalData()
    test_dataset = total_dataset.getTestData()
else: #args.dataset_name=='tweetsumm'
    total_dataset = TweetsummDataset_total(args.encoder_max_len,args.decoder_max_len,tokenizer,extra_supervision=True,paracomet=args.use_paracomet)
    train_dataset = total_dataset.getTrainData()
    eval_dataset = total_dataset.getEvalData()
    test_dataset = total_dataset.getTestData()
print('######################################################################')
